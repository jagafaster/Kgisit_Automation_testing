...
public class TS_002 extends BaseClass {
	...
	public void TC_003() throws Exception {
		try{
			...
			//homepage logo function
			WebElement logo = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/a/img"));
			logo.click();
	...
	public void TC_004() throws Exception {
		try{
			...
			try {
		        ...
		        Assert.assertEquals(currentUrl, "https://forever-frontend-gules.vercel.app/", "Logo did not navigate correctly!");
			}catch (Exception e){
