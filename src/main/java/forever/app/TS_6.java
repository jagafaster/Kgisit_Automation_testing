...
public class TS_6 extends BaseClass {
	...
	public void TC_015() throws Exception {
		try{
			...
			//collection link function
			WebElement collection = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/ul/a[2]/p"));
			collection.click();
	...
	public void TC_016() throws Exception {
		try{
			...
			try {
		        ...
		        Assert.assertEquals(currentUrl, "https://forever-frontend-gules.vercel.app/collection", "collection page did not navigate correctly!");
			}catch (Exception e){
