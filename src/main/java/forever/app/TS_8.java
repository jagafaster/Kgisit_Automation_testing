...
public class TS_8 extends BaseClass {
	...
	public void TC_011() throws Exception {
		try{
			...
			//about link function
			WebElement about = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/ul/a[3]/p"));
			about.click();
	...
	public void TC_012() throws Exception {
		try{
			...
			try {
		        ...
		        Assert.assertEquals(currentUrl, "https://forever-frontend-gules.vercel.app/about", "about page did not navigate correctly!");
			}catch (Exception e){
